...
--> statement-breakpoint
INSERT INTO `__new_tracks`("id", "name", "raw_artist_name", "album_id", "disc", "track", "year", "duration", "format", "bitrate", "sample_rate", "size", "uri", "modification_time", "discover_time", "artwork", "embedded_artwork", "alt_artwork", "is_favorite", "fetched_art", "edited_metadata", "hidden_at", "last_played_at", "play_count", "parent_folder") SELECT "id", "name", "raw_artist_name", "album_id", "disc", "track", "year", "duration", "format", "bitrate", "sample_rate", "size", "uri", "modification_time", "discover_time", "artwork", "embedded_artwork", "alt_artwork", "is_favorite", "fetched_art", "edited_metadata", "hidden_at", "last_played_at", "play_count", "parent_folder" FROM `tracks`;--> statement-breakpoint
